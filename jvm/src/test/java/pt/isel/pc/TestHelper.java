...
public class TestHelper {
    ...
    public interface TestFunction {
        void run(Supplier<Boolean> isDone) throws Exception;
    }
    ...
    public void createAndStart(TestFunction testFunction) {
        Thread th = new Thread(() -> {
            try {
                testFunction.run(isDone);
